...
const App: React.FC = () => {
  ...
  const handleLogin = useCallback(async (userId: string): Promise<void> => {
    ...
    if (foundStudent) {
      ...
      throw new Error('الكود غير صحيح، يرجى مراجعة المدرس');
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-start p-4">
       <div className="fixed top-0 left-0 w-full h-full bg-gradient-to-br from-blue-900/50 via-slate-900 to-purple-900/50 mix-blend-screen opacity-50 z-0"></div>
